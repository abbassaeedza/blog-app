...
urlpatterns = [
    ...
    path('acccount/edit/', users_views.profile, name='profile'),
    path('acccount/security/', auth_views.PasswordChangeView.as_view(template_name='users/password_change.html'), name='password_change'),
    path('acccount/security/done', 
